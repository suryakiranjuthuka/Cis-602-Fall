...
if(isset($_POST['upload_template_form'])){
		...
		//$upload_dir = "images";
			...
			if($template->type == p_e){
				$upload_dir = "../template_images/email_images/plum_email/";
			}
			if($template->type == c_e){
				$upload_dir = "../template_images/email_images/client_email/";
			}
			if($template->type == p_lp){
				$upload_dir = "../template_images/lp_images/plum_lp/";
			}
			if($template->type == c_lp){
				$upload_dir = "../template_images/lp_images/client_lp/";
			}
		...
		if(move_uploaded_file($tmp_file, $upload_dir.$target_file)) {
			...
			//$session->message("Invalid Image Format");
			}
			
		$template_url_path = $upload_dir.$target_file;
		$template->url_path = $template_url_path;
...
<div class="md-modal md-effect-1" id="upload_template_modal">
		<div id="upload_template_modal_content" class="md-content"></br>
            ...
            <form id="uploadForm" method="post" action="user.php" enctype="multipart/form-data">
                  ...
                  <p><label>Upload Template</label><input style="margin-top:5px;" type="file" name="file_upload" /></p>
